...
public class PwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public PwdAuthenticationProvider(AuthenticationManager authenticationManager,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2ClientAuthenticationToken clientPrincipal = getAuthenticatedClientElseThrowInvalidClient(pwdAuthenticationToken);
        ...
        Authentication usernamePasswordAuthentication = getUsernamePasswordAuthentication(pwdAuthenticationToken);

        //验证Scope
        Set<String> authorizedScopes = registeredClient.getScopes();
        Set<String> requestedScopes = pwdAuthenticationToken.getScopes();
        ...
        DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
                ...
                .authorizationGrant(pwdAuthenticationToken);
    ...
    public boolean supports(Class<?> authentication) {
        boolean supports = PwdAuthenticationToken.class.isAssignableFrom(authentication);
        LOGGER.debug("supports authentication=" + authentication + " returning " + supports);
        return supports;
    }

    private Authentication getUsernamePasswordAuthentication(PwdAuthenticationToken resouceOwnerPasswordAuthentication) {
